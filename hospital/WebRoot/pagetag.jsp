...
<script type="text/javascript">
			...
			function serch_reselt(pagenum,pageunit){
				mainForm.action =document.getElementById("_cond").value + "&currentpage="+pagenum+"&pageunit="+pageunit;
				mainForm.submit();
			}
   ...
   <table   class="trcolor04"   width = "100%" border = "0" rules = "none">
		<tr align = "center">
			...
			<td align = "left">
				<logic:notEqual name="pageinfo" property="currentpage" value="${pageinfo.pagenum}">
