...
<body class="ContentBody">
  <form action="/hospital/picture.do?mtype=updatePicture" enctype="multipart/form-data" method="post"  name="mainForm" id="mainForm" onSubmit="return checkValue()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
      <td align="left" ><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;照片信息修改</font></td>
  </tr>
  <tr>
    <td class="CPanel">		
			...
			<td width="100%">
				...
				<legend>照片信息</legend>
					  ...
					  <tr>
				        ...
				        <input name='picturename' type="text" class="text" style="width:354px" value="${picture.picturename }"/>
				        <input name='id' type="hidden" class="text" style="width:354px" value="${picture.id }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    <td align="right" width="19%">上传:</td>
					    <td width="35%"><span class="red">
				        <input name='file' type="file" class="text" style="width:354px" value=""/>
				        *</span><img src="/hospital/upload/${picture.url }" width="35" height="35" >
				        </td>
					  </tr>
					  </table>
			  <br />
