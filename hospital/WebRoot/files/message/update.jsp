...
<script type="text/javascript">
		function checkValue(){
				if(document.mainForm.reply.value==""||document.mainForm.reply.value==null)
				{
					alert("不能为空！");
...
<body class="ContentBody">
  <form action="/hospital/message.do?mtype=updateMessage" method="post"  name="mainForm" id="mainForm" onSubmit="return checkValue()" >
<div class="MainDiv">
