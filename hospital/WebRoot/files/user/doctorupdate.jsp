...
<script type="text/javascript">
		function checkValue(){
				...
				if(document.mainForm.work.value==""||document.mainForm.work.value==null)
				{
					alert("不能为空！");
					document.mainForm.work.focus();
					return false;
				}				
				return true;
		}
			...
			<td width="100%">
				...
				<legend>用户信息</legend>
					  ...
					  <tr>
				        ...
				        <input name='flag' type="hidden" class="text" style="width:354px" value="${flag}"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='age' type="text" class="text" style="width:354px" value="${user.age }"/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
				        ...
				        <select name="office">
				        	...
				        	<option value="${l.officename }" <c:if test="${user.office==l.officename }">selected="selected"</c:if> > ${l.officename }</option>
				        	</c:forEach>
				        </select>
				        *</span>
				        </td>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='work' type="text" class="text" style="width:354px" value="${user.work }"/>
				        *</span>
				        </td>
					  </tr>						  
					  </table>
