			...
			<td width="100%">
				...
				<legend>用户信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='seeid' type="text" class="text" style="width:354px" value="${user.seeid }"/>
				        *</span>
				        </td>
					  </tr>	
					<!--  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='caseid' type="text" class="text" style="width:354px" value="${user.caseid }"/>
				        *</span>
				        </td>
					  </tr>
					<!--    <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='pricetype' type="text" class="text" style="width:354px" value="${user.pricetype }"/>
				        *</span>
				        </td>
					  </tr>		-->			  
					  </table>
