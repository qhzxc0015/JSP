...
<body class="ContentBody">
  <form action="/hospital/news.do?mtype=addNews" method="post"  name="mainForm" id="mainForm" onSubmit="return checkValue()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  ...
  <tr>
      <td align="left" ><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;医疗添加</font></td>
  </tr>
  <tr>
    <td class="CPanel">		
			...
			<td width="100%">
				...
				<legend>医疗信息</legend>
					  ...
					  <tr>
				        ...
				        <input name='news' type="text" class="text" style="width:354px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='pills' type="text" class="text" style="width:354px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  <tr>
					    ...
					    <td width="35%"><span class="red">
				        <input name='price' type="text" class="text" style="width:354px" value=""/>
				        *</span>
				        </td>
					  </tr>
					  </table>
