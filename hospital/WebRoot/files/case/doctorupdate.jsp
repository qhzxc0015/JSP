...
<script type="text/javascript">
		function checkValue(){
				if(document.mainForm.doctormg.value==""||document.mainForm.doctormg.value==null)
				{
					alert("不能为空！");
					document.mainForm.doctormg.focus();
					return false;
				}
				return true;
		}
		...
		<tr>
			<td width="100%">
				...
				<legend>医疗信息</legend>
					  ...
					  <tr>
					    <td align="right" width="19%">管理员填写:</td>
					    <td width="35%"><span class="red">
				        <input name='doctormg' type="text" class="text" style="width:354px" value="${case.doctormg }"/>
