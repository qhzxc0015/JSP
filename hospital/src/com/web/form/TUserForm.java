...
public class TUserForm extends ActionForm implements java.io.Serializable {
	...
	/** minimal constructor */
	public TUserForm(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public TUserForm(Integer id, String username, String password, String realname,
