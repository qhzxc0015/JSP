      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">病人出院登记</td>
            </tr>
            <tr>
              ...
              <form name="form1" method="post" action="StudentQCSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="30" colspan="2" align="center" style="color:red;">出院操作后将不可恢复！ 确定病人出院吗？</td>
                    </tr>
                  <tr>
                    <td height="30" align="right">病人住院号：</td>
                    <td><s:property value='cnbean.Student_Username'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">病人姓名：</td>
                    <td><s:property value='cnbean.Student_Name'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">病人性别：</td>
                    <td><s:property value='cnbean.Student_Sex'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">目前药剂：</td>
                    <td><s:property value='cnbean.Building_Name'/></td>
                  </tr>
                  <tr>
                    <td width="33%" height="30" align="right">目前用量：</td>
                    <td width="67%"><s:property value='cnbean.Domitory_Name'/></td>
                  </tr>
                  <tr>
                    <td height="30" align="right">出院备注：</td>
                  ...
                  <tr>
                    ...
                    <td><input type="submit" name="button" id="button" value="确定出院">
                      &nbsp;&nbsp;
