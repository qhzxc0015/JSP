      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">麻醉药剂管理</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="BuildingManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="28%" height="30" style="padding-left:20px;"> 功能导航： <a href="BuildingAdd.jsp">添加麻醉药剂种类</a></td>
                    <td width="72%">名称：
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center">
                        <a href="TBManager.action?Building_ID=${Building_ID}">使用医师</a> 
                        <a href="BuildingUpdate.action?Building_ID=${Building_ID}">修改</a> 
                        <a href="BuildingDel.action?Building_ID=${Building_ID}" onClick="return confirm('确定要删除该病房吗？')">删除</a>
                      </td>
                    </tr>
                  </s:iterator>
                </table></td>
