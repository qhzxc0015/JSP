      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">添加手术安排</td>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="StudentAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>患者住院号：</td>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>患者姓名：</td>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>病房：</td>
                    <td><input name="Student_Class" type="text" class="text2" id="Student_Class"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
                    <td><input type="submit" name="button" id="button" value="添加手术安排">
                      &nbsp;&nbsp;
